...
const Cancelled = () => {
  ...
  try {
    ...
    const transformed = orders
      .filter(order => order.status.toLowerCase() === 'cancelled') // Filter for pending orders
      .map((order) => ({
        id: order.id,
    ...
    <>
      ...
      <div className="w-full bg-white shadow-lg rounded-lg">
        <div className="flex justify-between items-center p-6 bg-white rounded-lg">
          <h1 className="text-2xl font-semibold text-gray-900">Cancelled List</h1>
        ...
        noDataComponent={
          <div className="flex flex-col items-center justify-center py-8">
            <div className="text-gray-500 text-lg mb-2">No Cancelled found</div>
